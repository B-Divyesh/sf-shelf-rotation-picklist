...
Open `/?demo=1` to load the sample directly. `/demo` is an equivalent route. The first screen shows a generated three-game picklist from five fictional board games.
